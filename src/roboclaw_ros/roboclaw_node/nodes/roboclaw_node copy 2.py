...
class EncoderOdom:
    ...
    def update(self, enc_left_forw, enc_right_forw, enc_left_back, enc_right_back):
        ...
        # enc_left_back_ticks_amount += enc_left_back
        # rospy.loginfo(f"Encoder left back = {enc_left_back}")
        ...
        #     vel_left_forw = 0.0
        # else:
        #     vel_right_back = dist_right_back / d_time
        #     vel_right_forw = dist_right_forw / d_time
        #     vel_left_back = dist_left_back / d_time
        #     vel_left_forw = dist_left_forw / d_time
        ...
        self.cur_theta = self.normalize_angle(self.cur_theta +  2.2 * d_theta)
        ...
        # rospy.loginfo(f"Vel_y: {vel_y}")
        # #print("Distancia longitudinal: {:.4f}".format(dist))
        # rospy.loginfo(f"Vel_x: {vel_x}")
        # #print("Distancia angular: {:.4f}".format(d_theta))
        # rospy.loginfo(f"w_theta: {w_theta}")
