...
if("TRUE" STREQUAL "TRUE")
  set(hiro_panda_ik_SOURCE_PREFIX /home/brazo/workspace/rafi_ws/src/HIRO_Panda_TRAC_IK)
  set(hiro_panda_ik_DEVEL_PREFIX /home/brazo/workspace/rafi_ws/devel)
  ...
  set(hiro_panda_ik_INSTALL_PREFIX /home/brazo/workspace/rafi_ws/install)
...
if(NOT "/home/brazo/workspace/rafi_ws/src/HIRO_Panda_TRAC_IK/include;/home/brazo/libfranka/include " STREQUAL " ")
  set(hiro_panda_ik_INCLUDE_DIRS "")
  set(_include_dirs "/home/brazo/workspace/rafi_ws/src/HIRO_Panda_TRAC_IK/include;/home/brazo/libfranka/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'hiro_panda_ik' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/brazo/workspace/rafi_ws/src/HIRO_Panda_TRAC_IK/${idir}'.  ${_report}")
    endif()
    _list_append_unique(hiro_panda_ik_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "hiro_panda_ik_controllers;/home/brazo/libfranka/build/libfranka.so.0.9.2")
...
set(depends "controller_interface;franka_control;hardware_interface;franka_hw;message_runtime;pluginlib;realtime_tools;roscpp;geometry_msgs")
foreach(depend ${depends})
  ...
  _list_append_deduplicate(hiro_panda_ik_EXPORTED_TARGETS ${${hiro_panda_ik_dep}_EXPORTED_TARGETS})
endforeach()
